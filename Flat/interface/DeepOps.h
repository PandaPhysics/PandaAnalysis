...
namespace pa {
  ...
  public:
    ZvvHClassOp(panda::Event& event_,
                Config& cfg_,
                Utils& utils_,
                GeneralTree& gt_,
                int level_=0) :
  ...
  typedef DeepGenOp<panda::GenPart> DeepPGenOp;


  class BRegBDTOp : public AnalysisOp {
  public:
    BRegBDTOp(panda::Event& event_,
                Config& cfg_,
                Utils& utils_,
                GeneralTree& gt_,
                int level_=0) :
