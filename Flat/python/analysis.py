...
wlnhbb = lambda v=False : _analysis(
        ...
        bjetBDTReg = False,
        bjetDeepReg = True,
#        bjetDeepReg_withD0 = True,
#        bjetDeepReg_withPFs = True,
#        bjetDeepReg_withPFs_3 = True,
        varyJES = True,
        rerunJES = True,
        rerunJER = True,
        jetFlavorPartons = False,
...
deep_lstm = lambda v=False : _analysis(
        name = 'deep_lstm',
        verbose = v,
        ak8 = False,
        deep = True,
...
regval = lambda v=False : _analysis(
        name = 'wlnhbb',
        verbose = v,
        ak8 = True,
        hbb = True,
...
regval_withPFs = lambda v=False : _analysis(
        name = 'wlnhbb',
        verbose = v,
        ak8 = True,
        hbb = True,
...
regval_withPFs_EtaPhi = lambda v=False : _analysis(
        name = 'wlnhbb',
        verbose = v,
        ak8 = True,
        hbb = True,
...
regval_EtaPhi = lambda v=False : _analysis(
        name = 'wlnhbb',
        verbose = v,
        ak8 = True,
        hbb = True,
...
regval_withD0 = lambda v=False : _analysis(
        name = 'wlnhbb',
        verbose = v,
        ak8 = True,
        hbb = True,
