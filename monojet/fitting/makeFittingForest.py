...
#    factory.add_process(f('GJets'),'GJ',is_data=False,extra_weights={'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['pho'])
# data
    ...
    factory.add_process(f('SinglePhoton'),'QCD',is_data=True, extra_weights = {'nominal':sel.weights['fkp']%lumi},replace_cut=sel.cuts['fkp'])
    vmap['met']= u
...
#    factory.add_process(f('WJetsToLNu_HT'),'WJ',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['met'])
#    factory.add_process(f('ZJetsToNuNu_HT'),'Zvv',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['met'])

    factory.add_process(f('sum'),'Data',is_data=False,extra_weights = {'nominal':sel.weights['wjk_sig']%lumi},extra_cut=sel.triggers['met'])
    ...
    factory.add_process(f('ZJetsToNuNu_HT-100To200'),'ST',is_data=False,extra_weights={'nominal':'0.00000001'})
...
#    factory.add_process(f('DYJetsToLL_M-50'),'Zll',is_data=False,extra_cut=sel.triggers['met'])
...
#    factory.add_process(f('WJetsToLNu_HT'),'WJ',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['met'])
#    factory.add_process(f('ST'),'ST',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['met'])
#    factory.add_process(f('DYJetsToLL_M-50'),'Zll',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['met'])
#    factory.add_process(f('TTJets'),'TT',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['met'])
#    factory.add_process(f('Diboson'),'Diboson',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['met']) 
...
#    factory.add_process(f('DYJetsToLL_M-50'),'Zll',is_data=False,extra_cut=sel.triggers['ele'])
...
#    factory.add_process(f('WJetsToLNu_HT'),'WJ',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['ele'])
#    factory.add_process(f('ST'),'ST',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['ele'])
#    factory.add_process(f('DYJetsToLL_M-50'),'Zll',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['ele'])
#    factory.add_process(f('TTJets'),'TT',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['ele'])
#    factory.add_process(f('Diboson'),'Diboson',is_data=False,extra_weights = {'nominal':sel.weights['nom']%lumi},extra_cut=sel.triggers['ele'])


    factory.add_process(f('ST'),'QCD',is_data=False,extra_weights={'nominal':'0.000000001'})
    factory.add_process(f('ST'),'GJ',is_data=False,extra_weights={'nominal':'0.000000001'})
# data
    factory.add_process(f('SingleEGamma'),'Data',is_data=True,extra_cut=sel.triggers['ele'])
